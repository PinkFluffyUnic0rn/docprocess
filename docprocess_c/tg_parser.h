...
enum TG_TYPE {
	...
	TG_T_REFOP,		TG_T_ADDOP,	TG_T_MULTOP,
	TG_T_DDOT,		TG_T_ASSIGNOP,	TG_T_QUEST,
	TG_T_NEXTTOOP,		TG_T_GLOBAL,	TG_T_FUNCTION,
	TG_T_FOR,		TG_T_IF,	TG_T_ELSE,
	TG_T_CONTINUE,		TG_T_BREAK,	TG_T_RETURN,
	TG_T_IN,		TG_T_COLUMNS,	TG_T_DOT,
	TG_T_LBRC,		TG_T_RBRC,	TG_T_LBRK,
	TG_T_RBRK,		TG_T_EOF,	TG_T_ERROR,
	TG_T_END,
	...
	TG_N_ADDRESS,		TG_N_VAL,	TG_N_CONST,
	TG_N_INDEX,		TG_N_FILTER,	TG_N_RANGE,
	TG_N_ARGS,		TG_N_ATTR
};
