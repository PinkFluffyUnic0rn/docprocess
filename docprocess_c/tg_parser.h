...
enum TG_T_TYPE {
	...
	TG_T_OR,	TG_T_TILDA,	TG_T_COMMA,	TG_T_NOT,
	TG_T_SEMICOL,	TG_T_COLON,	TG_T_DOL,	TG_T_ADDOP,
	TG_T_MULTOP,	TG_T_DDOT,	TG_T_ERROR,	TG_T_ASSIGN,
	TG_T_QUEST,	TG_T_NEXTTOOP,	TG_T_GLOBAL,	TG_T_FUNCTION,
	TG_T_FOR,	TG_T_IF,	TG_T_ELSE,	TG_T_CONTINUE,
	TG_T_BREAK,	TG_T_RETURN,	TG_T_IN,	TG_T_DOT,
	TG_T_LBRC,	TG_T_RBRC,	TG_T_LBRK,	TG_T_RBRK,
	TG_T_EOF
};
